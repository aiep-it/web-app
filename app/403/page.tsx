    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-white p-6">
      <main className="max-w-3xl w-full bg-white shadow-md rounded-2xl p-8 md:p-12 ring-1 ring-black/5">
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="mt-2 text-lg text-gray-600 max-w-xl">
              Your account doesn’t have the necessary role to view this page. If you
              believe this is a mistake, contact your administrator or request access.
            </p>
            ...
            <div className="mt-6 text-sm text-gray-500">
              <p>
                Required role: <span className="font-medium text-gray-900">ADMIN</span>
              </p>
              <p className="mt-1">Your role: <em className="text-gray-700">(not authorized)</em></p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 border-t pt-6 text-sm text-gray-500">
          <p>
            Tip: If you’re an admin, make sure your account has <code>role: "ADMIN"</code>
            set in the Clerk publicMetadata or ask an admin to grant the role.
          </p>
        </div>
      </main>
    </div>
