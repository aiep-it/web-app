...
import {
  ...
  ModalHeader, ModalBody, ModalFooter, Spinner, Checkbox
} from "@heroui/react";
                ...
                {mode === 'select' ? (
                  <Checkbox
                    ...
                    onValueChange={(checked) =>
                      checked ? onSelectStudent?.(s.id) : onDeselectStudent?.(s.id)
                    }
                  />
                ) : mode === 'class' ? (
                  <Button
                  ...
                  >
                    <Icon icon="lucide:trash-2" className="text-lg" /> Xóa khỏi lớp
                  </Button>
                ) : (
